  ...
  async (message, match) => {
    ...
    let rudh = {
      key: {
        ...
        remoteJid: "120363252766300457@g.us"
      },
      message: {
        productMessage: {
          product: {
      ...
      buff,
      {
        ...
        contextInfo: {
          externalAdReply: {
            ...
            mediaUrl: "https://github.com/princerudh/rudhra-md",
            mediaType: 1,
...
Rudhra(
  ...
  async (message, match, m) => {
    try {
      ...
      const response = await getJson(RudhApi + `youtube?search=${encodeURIComponent(match)}`);
